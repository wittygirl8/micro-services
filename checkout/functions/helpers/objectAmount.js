...
export const amountObject = async (dbInstance, documentXray, obj) => {
    documentXray.addAnnotation('merchant_id', obj.merchantId);
    ...
    documentXray.addMetadata('fee_tier_id', fee_tier_id);
    documentXray.addMetadata('country_id', country_id);
    ...
    documentXray.addMetadata('amountItems', amountItems);
    return amountItems;
};
